...
//        this.TestState.Runtime.forEach(function(element, index, array){array[index] = 0});
    ...
    ListeningTest.prototype.runTest = function(TestIdx) {
        ...
        if (typeof this.TestState.Ratings[this.TestState.CurrentTest*this.TestConfig.Tasksets.length+this.TestState.CurrentTask-1] !== 'undefined') this.readRatings(this.TestConfig.Tasksets.length, this.TestState.CurrentTest, this.TestState.CurrentTask);
    ...
    ListeningTest.prototype.readRatings = function (Tasklength, CurrentTestIdx, TaskIdx) {
...
MushraTest.prototype.readRatings = function (Tasklength, CurrentTestIdx, TaskIdx) {
    ...
    $(".rateSlider").each( function() {
        ...
        $(this).slider('value', testObject.TestState.Ratings[Tasklength*CurrentTestIdx+TaskIdx-1][fileNum]);
        $(this).slider('refresh');
    });
...
MushraTest.prototype.createTestDOM = function (TestIdx) {
		...
		description.innerHTML = this.TestConfig.Tasksets[this.TestState.CurrentTask-1].Description;
